...
class Game(DirectObject):
    ...
    def __init__(self):
        ...
        self.player=PC(keymap,'models/model_girl_skirt')
        ...
        to_pos=(0,0,0)
        ropeNode = BulletSoftBodyNode.makeRope(info, from_pos, to_pos, res=2, fixeds=0) 
        #material and properties setup        	
        ropeNode.getMaterial(0).setLinearStiffness(0.1) 	
        ropeNode.getMaterial(0).setAngularStiffness(0.6)
        ropeNode.getCfg().setDampingCoefficient(0.3)        
        ...
        self.ref_node.wrtReparentTo(self.hip_bone)
